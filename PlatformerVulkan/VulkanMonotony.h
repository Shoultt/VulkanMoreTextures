...
void inputTexture()
{
	std::cout << "Write number picture:" << std::endl;
	std::cout << "	1.alkogol" << std::endl;
	std::cout << "	2.arfa" << std::endl;
	std::cout << "	3.basseyn" << std::endl;
	std::cout << "	4.bogomol" << std::endl;
	std::cout << "	5.gandon" << std::endl;
	std::cout << "	6.glitch" << std::endl;
	std::cout << "	7.kurevo" << std::endl;
	std::cout << "	8.luzha" << std::endl;
	std::cout << "	9.magazin" << std::endl;
	std::cout << "	10.nebo" << std::endl;
	std::cout << "	11.orange" << std::endl;
	std::cout << "	12.restoran" << std::endl;
	std::cout << "	13.secunda" << std::endl;
	std::cout << "	14.solnce" << std::endl;
	std::cout << "	15.stop" << std::endl;
	std::cout << "	16.toska" << std::endl;
	std::cout << "	17.true" << std::endl;
	std::cout << "	18.vazhno" << std::endl;
	std::cout << "	19.vodopad" << std::endl;
	std::cout << "	20.yasno" << std::endl;
	std::cout << "	else: zvezdopad" << std::endl;

	int number = 0;
	std::cin >> number;

	textureName = "Textures/zvezdopad.jpg";
	switch (number)
	{
		case 1:
			textureName = "Textures/alkogol.jpg";
			break;
		case 2:
			textureName = "Textures/arfa.jpg";
			break;
		case 3:
			textureName = "Textures/basseyn.jpg";
			break;
		case 4:
			textureName = "Textures/bogomol.jpg";
			break;
		case 5:
			textureName = "Textures/gandon.jpg";
			break;
		case 6:
			textureName = "Textures/glitch.jpg";
			break;
		case 7:
			textureName = "Textures/kurevo.jpg";
			break;
		case 8:
			textureName = "Textures/luzha.jpg";
			break;
		case 9:
			textureName = "Textures/magazin.jpg";
			break;
		case 10:
			textureName = "Textures/nebo.jpg";
			break;
		case 11:
			textureName = "Textures/orange.jpg";
			break;
		case 12:
			textureName = "Textures/restoran.jpg";
			break;
		case 13:
			textureName = "Textures/secunda.jpg";
			break;
		case 14:
			textureName = "Textures/solnce.jpg";
			break;
		case 15:
			textureName = "Textures/stop.jpg";
			break;
		case 16:
			textureName = "Textures/toska.jpg";
			break;
		case 17:
			textureName = "Textures/true.jpg";
			break;
		case 18:
			textureName = "Textures/vazhno.jpg";
			break;
		case 19:
			textureName = "Textures/vodopad.jpg";
			break;
		case 20:
			textureName = "Textures/yasno.jpg";
			break;
	}
	std::cout << std::endl << textureName << std::endl << std::endl;
}